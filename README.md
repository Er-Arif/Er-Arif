...
Full-stack software developer building secure web platforms, backend services, offline-first applications, and practical AI-enabled products.

- 🎓 B.E. in Computer Science and Engineering, Chandigarh University (2020–2024)
- 💻 Focused on full-stack, backend, and GenAI application development
- 🌍 Open to remote opportunities and relocation across India
- ⚡ Available to join immediately
- 🌐 Portfolio: [arifali.me](https://arifali.me)
- ✉️ Email: [dev.arifali@gmail.com](mailto:dev.arifali@gmail.com)
...
**Backend:** FastAPI, Node.js, Express, Flask, Django, REST APIs, JWT  
**Data:** PostgreSQL, MySQL, SQLite, Redis, Prisma, SQLAlchemy  
**AI/ML:** LangGraph, Groq, PyTorch, TensorFlow/Keras, scikit-learn, OpenCV, NLP  
**Engineering:** Docker, GitHub Actions, testing, authentication, encryption, payments, background jobs
...
- Applied AI and LLM-powered workflows
- Reliable business software and operational tooling

## Connect

[LinkedIn](https://www.linkedin.com/in/arifali2904) · [Portfolio](https://arifali.me) · [Email](mailto:dev.arifali@gmail.com)
